...
--
-- Host: 127.0.0.1
-- Generation Time: May 15, 2024 at 04:35 PM
...
INSERT INTO `users` (`NIK`, `username`, `email`, `dob`, `department`, `password`, `login_attempts`, `is_locked`, `lockout_time`, `role_status`) VALUES
('11111', 'juan', 'juan.saputro@binus.edu', '2024-05-14', 'Finance', '$2y$10$GrUW8LF/leSpr/lEW2fZReiPqjsvaWQNPJCiivuzMTu0h8e.wbyjC', 1, 0, NULL, 1),
('11112', 'christopher', 'christopher023@binus.ac.id', '2024-05-14', 'Finance', '$2y$10$QV2tFe3up/HZDaXYcndTF.we/B1UOQ12eavfILFx6ckMOsf4dVOnS', 0, 0, NULL, 1),
('11113', 'egbert', 'egbert@binus.edu', '2024-05-14', 'Finance', '$2y$10$h8nssc0nk5Mzic.5df.nEeX7QfgZ/brhFs19EYhWFmLVNiNHQfcbu', 1, 0, NULL, 1),
('11114', 'Silvanus', 'Silvanus.Suryadi@binus.edu', '2024-05-14', 'IT', '$2y$10$332CSEzaEprYjbKc6pbtSOH5dtMNaHPWMrvxcvH9zXSAjKRmPwIES', 0, 0, NULL, 1),
('11115', 'christopher-', 'christopher-23@binus.ac.id', '2024-05-14', 'IT', '$2y$10$Z2NE6rvPJg384WhDhukCieyeiFqleAen78DOaIyu.VKhc7mPR5Eoi', 0, 0, NULL, 1),
('11116', 'tesadmin', 'tesadmin@binus.edu', '2024-05-14', 'IT', '$2y$10$wdHAHes0SQ1v41wkz4CRCupKbDEzx7d6QIqfOMcIP..z3HNpqLOBG', 0, 0, NULL, 2),
('11117', 'bocahkontol', 'bocahkontol@binus.edu', '2024-05-14', 'Finance', '$2y$10$QOF/XMbl9E.iB9zBeKa07eL.qSpXxo1SVlkXVlBiZ6WrQaZi8uehi', 0, 0, NULL, 1),
('11118', 'adminlagi', 'adminlagi@binus.edu', '2024-05-15', 'IT', '$2y$10$xox7tqFoMZ.fdyZT4oC2.uLSavEOR82ZxY.yeOw5e/uqB/Ucf1gbW', 0, 0, NULL, 1),
('11119', 'egbert', 'egbert09@gmail.com', '2024-05-15', 'IT', '$2y$10$JlBBWBMdLQf2anL3qyFoYeC6IUm8naNTDpY7CZ8i8C4OLROF9b41m', 0, 0, NULL, 1);
