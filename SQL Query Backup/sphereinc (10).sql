...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2024 at 10:44 AM
...
('11111', 'tesadmin', 'tesadmin@binus.edu', '2024-04-15', 'IT', '$2y$10$hSxlj6aDVDjjHyL51K9bk.84dq5ni5NxxuBSwjrPldheqhKzyefee', 0, 0, '1970-01-01 07:00:00', 1, 1, 0),
('11112', 'nonadmin', 'nonadmin@binus.edu', '2024-05-17', 'Finance', '$2y$10$ms3q6EdABjFJUWYqoc59pOLh0/1sBSXB9pocqmD4tR.XDf4BwZvla', 0, 0, NULL, 1, 0, 0);
...
--
ALTER TABLE `status`
  MODIFY `PingID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
